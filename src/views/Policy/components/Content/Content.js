...
const mock = [
  ...
  },
  {
    ...
    paragraph1:
      '10.2 Contact Information: privacy@virtualground.org.',
    
  },
  
];

const PrivacySection = ({ title, description, paragraph1, paragraph2, paragraph3, paragraph4, paragraph5, paragraph6, paragraph7, paragraph8, paragraph9}) => {
  return (
    <Box>
      <Typography
        variant={'h6'}
