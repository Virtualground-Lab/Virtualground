...
const mock = [
  {
    ...
    paragraph1:
      "The Site and the Tools may evolve over time, and this Privacy Policy will change to reflect that evolution. If changes are made, you will be notified by revising the date at the top of this Privacy Policy. In some cases, if significant changes are made, a statement may be placed on the homepage. We encourage you to review this Privacy Policy periodically to stay informed.",
    paragraph2:
    ...
    paragraph4:
      "1.3 Your use of the VGR Client and any personal information you provide through the Tools remains subject to the terms of this Privacy Policy and the Terms of Use, as each may be updated from time to time.",
    paragraph5:
      "1.4 Any questions, comments or complaints that you might have should be emailed to privacy@virtualground.org.",
  },

  {
    ...
    paragraph3: "2.3. Your email and Ether address.",
    paragraph4:
      "2.4 The VGR Client requires the highest level of browser permissions that could potentially lead to procurement of more personal information. Information on these permissions are used for a limited purpose, and why this is necessary, can be found in paragraph 3 below.",
    paragraph5:
      "2.5 Your interactions with the Site are documented and that information is processed by Google.",
  },
  {
    ...
    paragraph1:
      "3.2 The VGR Client requires full browser permissions that could potentially be used to access additional personal information. Such browser permissions are used for an extremely limited technical purpose of allowing the VGR Client to properly interact with your browser. No additional information is obtained beyond what is necessary to provide the VGR Client. No information received is shared with any third party except as required for the provision of the VGR Client.",
    paragraph2:
  ...
  },
  {
    ...
    description: "4.1 Your information may be used in the following ways:",
    paragraph1:
      "-- To analyze trends for how the Site and Tools are being used;",
    paragraph2: "-- To improve the Site and the Tools;",
    paragraph3:
      "-- To help personalize your experience of the Site and the Tools; and",
    paragraph4:
      "-- If you provide your contact information, you may receive technical notices, updates, confirmations, and security alerts, to provide support to you, tell you about other products and services that might interest you, or respond to your comments or questions.",
    paragraph5:
      "4.2 Your information may be shared with third parties who need to access it in order to do work related to the Site and the Tools, including doing things like helping make the Site or VGR Client available, or providing analytics services. These third parties only access and use your information as necessary to perform their functions.",
    paragraph6:
      "4.3 Aggregations and anonymizations that contain your information may be created in a way that does not directly identify you. Those aggregations and anonymizations may be used or shared for a variety of purposes related to the Site and the VGR Client.",
    paragraph7:
    ...
    paragraph8:
      "4.5 The Foundation also reserves the right to disclose personal information that it believes, in good faith, is appropriate or necessary to enforce the Terms of Use, take precautions against liability or harm, investigate and respond to third-party claims or allegations, to respond to court orders or official requests, to protect the security or integrity of the Site or the Tools, and to protect the rights, property, or safety of the Foundation, the Virtualground community of users and owners, or others.",
    paragraph9:
  ...
  },
  {
    ...
    paragraph2:
      "9.3. If you wish to investigate the exercising of any of these rights, please write to us at the following address: privacy@virtualground.org.      ",
  },
  {
    title: "10. Changes and Updates",
    description:
      "10.1 This Privacy Policy may be revised periodically and this will be reflected by the “Last update posted” date above. Please revisit this page to stay aware of any changes. Your continued use of the VGR Client constitutes your agreement to this Privacy Policy and any future revisions.",
    paragraph1: "10.2 Contact Information: privacy@virtualground.org.",
  },
];
